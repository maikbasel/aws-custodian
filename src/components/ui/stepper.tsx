...
const StepperProvider = ({ value, children }: StepperContextProviderProps) => {
  ...
  const contextValue = React.useMemo(
    ...
    [value, isError, isLoading, activeStep]
  );
  ...
  return (
    <>
      {React.Children.map(children, (child, i) => {
        ...
        const childProps = child.props as VerticalContentProps;
        const isCompletedStep = childProps.isCompletedStep ?? i < activeStep;
        const isLastStep = i === stepCount - 1;
        const isCurrentStep = i === activeStep;

        const stepProps: VerticalContentProps = {
          index: i,
          isCompletedStep,
          isCurrentStep,
          isLastStep,
